...
DF = load("/Users/dariabystrova/Documents/GitHub/approximatingBNPpriors/saves_for_figures/figure_6_4.jld")
DF_NGG_FK = DF["DF_NGG_FK"]
...
R"p_ngg_fk
pdf('/Users/dariabystrova/Documents/GitHub/approximatingBNPpriors/figures/figure_6_4.pdf', width= 4, height = 4)
plot(p_ngg_fk)
dev.off()"
