...
DF =load("/Users/dariabystrova/Documents/GitHub/approximatingBNPpriors/saves_for_figures/figure_2.jld")
DF_1000_250 = DF["DF_1000_250"]
n=1000
β= 1.0
ntr=250
sigma_vec= [0.25,0.75]
...
for i in (1:length(sigma_vec))
             P_all_approx_1000[i]= plot_draw_prior_distribution(DF_1000_250[1][i],N_plot[i],β,sigma_vec[i],y_l[i],x_lab[i],n,0)
...
x_lab=[" ","k"]
for i in (1:length(sigma_vec))
             P_all_approx_10_1000[i]= plot_draw_prior_distribution(DF_1000_250[2][i],N_plot[i],β,sigma_vec[i],y_l[i],x_lab[i],n,0)
...
pdf('/Users/dariabystrova/Documents/GitHub/approximatingBNPpriors/figures/figure_2.pdf')
plot(p)
dev.off()
"
